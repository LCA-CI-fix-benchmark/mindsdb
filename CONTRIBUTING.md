...
> NOTE: Be sure to merge the latest changes from "upstream" before making a pull request! Also, make the PR to the staging branch.Being part of the core MindsDB team is accessible to anyone who is motivated and wants to be part of that journey!
