...
1. If all the tests passed, append this line: `All Tests Passed: [link to the test results in your GitHub repository]`
2. If some tests failed, create an issue to report it and append this line: `Some Tests Failed: [link to the test results in your GitHub repository], [link to the issue]`

### Test Resultss QA Testing
